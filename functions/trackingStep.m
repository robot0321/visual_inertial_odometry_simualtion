...
%    
% INPUT    : feat_prevValidx, (previous/current)robotParams, cameraParams
...
function featGroup = trackingStep(feat_prevValidx, robotParamsPrev, robotParams, cameraParams)
    ...
    [feat_prevTrckPixel, feat_prevTrckNormal] = world2pixelNnormal_verFunc(feat_intrscPrevIdx, robotParamsPrev, cameraParams); % intersectValidx = feat_prevValidx(:, feat_intrscPrevIdx)
