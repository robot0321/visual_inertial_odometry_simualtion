...
if(dual_left_monitor) 
    figure(1); set(gcf,'Position',[-1700 50 1300 400]); % This is my workspace setting. 
else 
...
% posisiton and heading of robot, heading is the angle from world-x axis
traj = [0:fwd_speed:50, 50*ones(1,rot_time), 50*ones(size(0:fwd_speed:50)), 50*ones(1,rot_time),  50:-fwd_speed:0, 0*ones(1,rot_time), zeros(size(50:-fwd_speed:0));
...
for i=1:length(robot)
    ...
    plot(traj(1,:), traj(2,:),'r'); % trajectory
